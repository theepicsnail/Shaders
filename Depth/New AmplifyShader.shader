...
Shader "snail/Depth/New AmplifyShader"
{
	Properties
	{
	...
	SubShader
	{
		...
		{
			float switchResult1 = (((i.ASEVFace>0)?(1.0):(0.0)));
			float3 temp_cast_0 = (switchResult1).xxx;
...
/*ASEBEGIN
Version=14201
796;92;480;514;887.4495;292.0398;1.82634;True;False
Node;AmplifyShaderEditor.SwitchByFaceNode;1;-160.5663,38.52759;Float;False;2;0;FLOAT;1.0;False;1;FLOAT;0.0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=2537BF3E3B4F52A9199203CC3BF76A148DEA47A7
